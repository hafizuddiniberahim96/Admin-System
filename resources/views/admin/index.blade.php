    ...
    <div class="fade-in">
        <div class="card">
            <div class="card-header">
                ...
                <a  class="btn btn-labeled btn-success pull-right text-white" type="button"  data-placement="top" data-title="Admin" href="/admin-tools/create-admin">Create Admin</a>  
    ...
    <script>
        ...
        $(function () {
            var table = $('.table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.get.list.admin') }}",
                columns: [
